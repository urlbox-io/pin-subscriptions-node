...
Spreedly.prototype.updatePaymentCreditCardInfo = function( id, credit_card, billing_info, callback ) {
	$this = this;
...
Spreedly.prototype.addComplimentarySubscription = function( subscriber_id, quantity, units, feature_level, callback ) { // test
	$this = this;
