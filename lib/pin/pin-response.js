...
PinResponse.prototype.$unpad = function( value ) {
...
PinResponse.prototype.$get_datetime_value = function( value ) {
...
PinResponse.prototype.$get_typed_value = function( value, type ) {
	switch ( type ) {
		case "boolean":
			return value === 'true';
		case "decimal":
...
PinResponse.prototype.$get_normalized_single = function( data ) {
	var input = data;
	for (var key in input) {
		...
		if ( typeof input[key] !== "string" ) {
			if ( input[key]["$t"] != undefined ) {
				...
				if ( input[key].type == undefined ) {
					input[key] = PinResponse.prototype.$get_normalized_single(input[key]);
					// input[key] = null;
				} else {
					if ( input[key].nil != undefined ) {
						input[key] = null;
...
PinResponse.prototype.$get_normalized_array = function( data ) {
	var input = data;
...
PinResponse.prototype.plans_versions_response = function( json_input ) {
...
PinResponse.prototype.plans_response = function( json_input ) {
	var input = json_input;
